...
import com.ict.api.config.FeignConfiguration;
 ...
 */
@FeignClient(value = "usercenter", configuration = FeignConfiguration.class, fallbackFactory = RemoteUsercenterServiceFallbackFactory.class)
